...
SELECT count(DISTINCT m.m_id) FROM C_Match m , Team t , Venue v WHERE t.t_id=m.result and m.v_id IN(SELECT v1.v_id FROM Venue v1 , Team t1 WHERE t1.home_ground=v1.name and t1.name='Rajasthan Royals');
